...
class Conversation:
    def __init__(self) -> None:
        ...
        self._sub_speech = rospy.Subscriber(
            SPEECH_COMMAND_TOPIC, String, self.speech_callback)
    ...
    def process(self, request: str) -> str:
        ...
        if "feedback" in request:
            ...
            chat_prompt = self.interaction_guide["interact"] + "Prev prompts: " + \
                self.prompts_context + "Prev interactions: " + self.interactions_context
        elif "ask" in request:
            chat_prompt = self.interaction_guide["ask"] + "Prev prompts: " + \
                self.prompts_context + "Prev interactions: " + self.interactions_context
